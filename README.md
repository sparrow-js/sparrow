...
本项目由于设计的不够好，短期内不会有更新。新起了个分支，主要功能是源代码编辑和与chatgpt的结合，持续开发中感兴趣可以关注下：[https://github.com/sparrow-js/firefly ](https://github.com/sparrow-js/sparrow/tree/sparrow-next)
