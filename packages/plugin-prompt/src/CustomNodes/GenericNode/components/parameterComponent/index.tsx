...
import {
  ...
  isValidConnection,
  toFirstUpperCase,
 nodeNames, nodeIcons, nodeColors } from '../../../../utils';
  ...
  useEffect(() => {
    ...
    refHtml.current = groupedObj.map((item, i) => (
      ...
      >
        ...
        >
          {React.createElement(nodeIcons.unknown)}
        </div>
    ...
    >
      <>
        ...
        !data.node.template[name].options ? (
          ...
          <ListComponent
            disabled={disabled}
            value={data.node.template[name].dataList ?? []}
            onChange={(t: any) => {
              data.node.template[name].dataList = t;
              save();
            }}
          />
        ) : (
