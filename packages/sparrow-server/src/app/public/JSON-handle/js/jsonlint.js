			...
			var oLineCode = (function () {
				var _pub_static = function () {var _pri = {}, _pub = {};
					var _init = function (sJson) {
						...
						sJson = sJson.replace('@◆$#errorEm#$◆@', '<span class="errorEm">').replace('@◆$#/errorEm#$◆@', '</span>');
						sJson = '<ol><li><div>'+sJson.split('\n').join('</div></li><li><div>')+'</div></li></ol>'
						_pub["dom"] = $('<div class="line-code">'+sJson+'</div>');
					};
					...
					_pri["insertErrorFlag"] = function (s) {
						...
						jsonlint.yy.parseError = function (sError, oError) {
							...
							_pub.oError = oError;
							aLine[oError.line] = sLine.slice(0, oError.pos) + '@◆$#errorEm#$◆@' + sLine.slice(oError.pos) + '@◆$#/errorEm#$◆@';
						};
