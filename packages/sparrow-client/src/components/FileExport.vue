  ...
  <el-dialog
    ...
    <div class="path-box">
      ...
      <el-input
        ...
        <i @click="editPathHandler" slot="suffix" class="el-input__icon el-icon-edit"></i>
      </el-input>
    </div>
    <ul class="dir-list">
      <li class="dir-item" 
    ...
    <span slot="footer" class="dialog-footer">
      ...
      <el-button type="primary" @click="exportHandler" size="mini">确 定</el-button>
    </span>
  </el-dialog>
</template>
<script lang="ts">
