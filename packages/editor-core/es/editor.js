...
export var Editor = (_dec = obx.shallow, (_class = /*#__PURE__*/function (_ref) {
  _inheritsLoose(Editor, _ref);
  function Editor() {
    var _this;
     ...
     * @memberof Editor
     */
    _this.preference = new Preference();
    _this.hooks = [];
    _this.config = void 0;
        ...
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return Promise.all(remoteComponentDescriptions.map( /*#__PURE__*/function () {
              var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee(component) {
                var exportName, url;
